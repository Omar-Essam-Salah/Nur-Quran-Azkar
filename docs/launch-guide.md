...
- Google يعرض **إيميل** المطوّر على صفحة التطبيق (مطلوب قانونًا). أنشئ إيميلًا مخصّصًا (مثل `nur.quran.help@gmail.com`) واستخدمه كإيميل تواصل حتى لا يظهر بريدك الشخصي.
