// Page on which each surah begins in the standard 604-page Madani (Hafs) mushaf.
// Index 0 = Surah 1 (Al-Fatihah) … index 113 = Surah 114 (An-Nas).
...
export const startPageForSurah = (surahNumber: number): number =>
  SURAH_START_PAGES[surahNumber - 1] ?? 1;
