...
export const REMINDERS: Reminder[] = [
  ...
  { ar: 'تصدَّق اليوم ولو بالقليل؛ فالصدقةُ تُطفئ الخطيئة كما يُطفئ الماءُ النار.', en: 'Give in charity today — it extinguishes sins as water puts out fire.' },
  { ar: '«ما نقَص مالٌ من صدقة»؛ فأنفِق يُخلِف اللهُ عليك ويبارك لك.', en: '“Charity never decreases wealth” — give, and Allah will replenish you.' },
  { ar: 'الصدقةُ في السرّ تُطفئ غضب الرب، فابحث عن محتاجٍ وأعطه بلا مَنٍّ.', en: 'Secret charity cools the Lord’s anger — give quietly, without reproach.' },
  { ar: '﴿مَن ذَا الَّذِي يُقْرِضُ اللَّهَ قَرْضًا حَسَنًا فَيُضَاعِفَهُ لَهُ﴾ — قرضُك لله لا يضيع.', en: 'Lend to Allah a goodly loan and He will multiply it for you.' },
  { ar: 'ابحث عن صدقةٍ جارية: مصحفٌ يُقرأ، أو ماءٌ يُسبَّل، أو علمٌ يُنشر — يجري أجرها بعد موتك.', en: 'Seek an ongoing charity — its reward flows on even after you pass.' },
  { ar: 'يوم الجمعة موسمُ خير؛ فأكثِر فيه من الصدقة والصلاة على النبي ﷺ.', en: 'Friday is a season of good — give charity and send blessings on the Prophet ﷺ.' },
