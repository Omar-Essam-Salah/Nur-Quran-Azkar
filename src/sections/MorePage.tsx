import {
  ...
  Search, X, HandHeart, Brain, Sun, Palette,
} from 'lucide-react';
...
const GROUPS: { en: string; ar: string; items: Item[] }[] = [
  {
    ...
    items: [
      ...
      { page: 'duas', en: 'Duʿāʾ Library', ar: 'أدعية لكل موقف', icon: HandHeart, color: '#f472b6' },
  ...
  },
  {
    ...
    items: [
      ...
      { page: 'tajweed', en: 'Tajwīd Guide', ar: 'دليل التجويد', icon: Palette, color: '#9400a8' },
